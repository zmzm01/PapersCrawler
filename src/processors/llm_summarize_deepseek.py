...
if __name__ == "__main__":
    ...
    paperMDpath = Path("/path/to/Code/PapersCrawler/TEST/MinerU_Paper_Parser/qdgp-tydj/full.md")
    full_text = paperMDpath.read_text()
    llm_summary = summarizer.call_deepseek_api(full_text, SUMMARIES_PROMPT)
    from pprint import pprint
    pprint(llm_summary)
    save_dir = Path("/path/to/Code/PapersCrawler/TEST/MinerU_Paper_Parser")
