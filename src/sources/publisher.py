...
if __name__ == "__main__":
    ...
    # nScraper = NatureScraper("/path/to/Code/PapersCrawler/TEST/publisher_test/chrome_cache/nature")
    # nScraper.start_browser()
    # nScraper.fetch_page(url)
    # paper = nScraper.parse_page()
    # pprint(paper)
    # html_path = Path("/path/to/Code/PapersCrawler/TEST/publisher_test/html_example/nature_news.html")
    # nScraper.save_page(html_path)
    # nScraper.close()

    # Science 测试
    # url = "https://www.science.org/doi/abs/10.1126/science.adx9954?af=R"
    # sScraper = ScienceScraper("/path/to/Code/PapersCrawler/TEST/publisher_test/chrome_cache/science")
    # sScraper.start_browser()
    # sScraper.fetch_page(url)
    # paper = sScraper.parse_page()
    # pprint(paper)
    # html_path = Path("/path/to/Code/PapersCrawler/TEST/publisher_test/html_example/science.html")
    # sScraper.save_page(html_path)
    # sScraper.close()

    # APS 测试
    # url = "https://journals.aps.org/prl/abstract/10.1103/yq7c-8bsv"
    # apsScraper = APSScraper("/path/to/Code/PapersCrawler/TEST/publisher_test/chrome_cache/aps")
    # apsScraper.start_browser()
    # apsScraper.fetch_page(url)
    # paper = apsScraper.parse_page()
    # pprint(paper)
    # html_path = Path("/path/to/Code/PapersCrawler/TEST/publisher_test/html_example/aps.html")
    # apsScraper.save_page(html_path)
    # apsScraper.close()

    # Cambridge 测试
    # url = "https://dx.doi.org/10.1017/hpl.2025.10090?rft_dat=source%3Ddrss"
    # cScraper = CambridgeScraper("/path/to/Code/PapersCrawler/TEST/publisher_test/chrome_cache/cambridge")
    # cScraper.start_browser()
    # cScraper.fetch_page(url)
    # paper = cScraper.parse_page()
    # pprint(paper)
    # html_path = Path("/path/to/Code/PapersCrawler/TEST/publisher_test/html_example/cambridge.html")
    ...
    # aipScraper = AIPScraper("/path/to/Code/PapersCrawler/TEST/publisher_test/chrome_cache/AIP")
    # aipScraper.start_browser()
    # aipScraper.fetch_page(url)
    # paper = aipScraper.parse_page()
    # pprint(paper)
    # html_path = Path("/path/to/Code/PapersCrawler/TEST/publisher_test/html_example/aip.html")
    # aipScraper.save_page(html_path)
    # aipScraper.close()

    # IOP 测试
    # url = "https://iopscience.iop.org/article/10.1088/1361-6587/ae5adb"
    # iopScraper = IOPScraper("/path/to/Code/PapersCrawler/TEST/publisher_test/chrome_cache/IOP")
    # iopScraper.start_browser()
    # iopScraper.fetch_page(url)
    # paper = iopScraper.parse_page()
    # pprint(paper)
    # html_path = Path("/path/to/Code/PapersCrawler/TEST/publisher_test/html_example/iop.html")
    ...
    # optScraper = OpticaScraper("/path/to/Code/PapersCrawler/TEST/publisher_test/chrome_cache/Optica")
    ...
    # pprint(paper)
    # html_path = Path("/path/to/Code/PapersCrawler/TEST/publisher_test/html_example/optica.html")
